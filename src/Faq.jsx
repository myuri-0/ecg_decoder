...
const EcgFaqPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Убедитесь, что вазелин поддерживаемого формата не превышает допустимые для вас НОРМЫ. В случае ошибки попробуйте использовать другого производителя или уточните состав в аптеке при покупке. Не забудьте обратиться в службу поддержки."
    }
  ];
